...
namespace webService.App_Code
{
    public class MyUser : IDbAction
    {
        ...
        public static MyUser GetUserByEmailPassword(string userEmail, string userPassword)
        {
        ...
        // get a list of users
        public static List<MyUser> GetUsersList()
        {
            ...
            for (i = 0; i < amountOfUsers; i++)
            {
                ...
                userList.Add(new MyUser(newUserId));
            }
